...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="mb-0 fw-bold">Add New Material Layout Group</h3>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <div class="">
                <form action="{{ route('admin.material.layout.group.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <!-- Name -->
                        ...
                        <!-- Layout Category -->
                        <div class="col-md-4 mb-3">
                            <label for="layout_category_id">Layout Category</label><span style="color:red;">*</span>
                            <select class="form-select" name="layout_category_id" id="layout_category_id">
                                ...
                                <option value="{{ $category->id }}"
                                    {{ old('layout_category_id') == $category->id ? 'selected' : '' }}>
                                    {{ $category->name }}
                                </option>
                                @endforeach
                            </select>
