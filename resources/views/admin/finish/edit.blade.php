...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="mb-0 fw-bold">Edit Finish</h3>
...
$(document).ready(function() {
    var currentMaterialTypeId = {{ old('material_type_id', $finish->material_type_id) ?? 'null' }};
    ...
    $('#material_group_id').on('change', function() {
        ...
        if (materialGroupId) {
            ...
            $.ajax({
                url: '{{ route("admin.finish.getMaterialTypes") }}',
                type: 'GET',
                data: {
    ...
    @if(old('material_group_id') && old('material_group_id') != $finish->material_group_id)
