...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3 listing_name">
        <h3 class="mb-0 fw-bold">Cut Outs List</h3>
        <a href="{{ route('admin.cut.outs.create') }}" class="btn btn-primary btn-custom-add">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('admin.cut.outs.destroy', $item->id) }}" method="POST"
                        ...
                        @empty
                        <tr>
                            <td colspan="7" class="text-center text-muted">No cut outs found.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
                ...
                <div class="mt-3">
                    {{ $outs->links('pagination::bootstrap-5') }}
                </div>
            </div>
        </div>
    </div>
