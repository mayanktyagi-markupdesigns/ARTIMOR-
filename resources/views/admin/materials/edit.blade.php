...
<div class="container mt-4">
    ...
    <div class="card shadow-sm">
        <div class="card-body">  
            ...
            <div class="">
                <form action="{{ route('admin.material.update', $materials->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <!-- Name -->
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select" name="material_type" id="material_type">
                                <option value="Natural Stone" {{ old('material_type', $materials->material_type) == 'Natural Stone' ? 'selected' : '' }}>Natural Stone</option>
                                <option value="Ceramics" {{ old('material_type', $materials->material_type) == 'Ceramics' ? 'selected' : '' }}>Ceramics</option>
                                <option value="Quartz" {{ old('material_type', $materials->material_type) == 'Quartz' ? 'selected' : '' }}>Quartz</option>
                            </select>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            @if($materials->image)
                                <img src="{{ asset('uploads/materials/'.$materials->image) }}" 
                                     alt="Material Image" class="img-thumbnail mt-2" width="120">
                            @endif
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select" name="status" id="status">
                                <option value="1" {{ old('status', $materials->status) == '1' ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ old('status', $materials->status) == '0' ? 'selected' : '' }}>Inactive</option>
                            </select>
