...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="mb-0 fw-bold">Edit Backsplash Shapes</h3>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <form action="{{ route('admin.backsplash.shapes.update', $shape->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        @if($shape->image)
                        <img src="{{ asset('uploads/backsplash-shape/' . $shape->image) }}" class="img-thumbnail mt-2"
                            width="120">
                        @endif
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="sort_order" class="form-control" value="{{ $shape->sort_order }}"
                            required>
                    </div>
